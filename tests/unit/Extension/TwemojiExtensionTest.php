...
class TwemojiExtensionTest extends TestCase
{
    ...
    public function testSetAsDefaultConversionType(): void
    {
        ...
        $raw      = '🙍🏿‍♂️ is leaving on an &#x2708;️. Going to 🇦🇺. Might see some :kangaroo:! <3 Remember to 📱 :D';
        $expected = '🙍🏿‍♂️ is leaving on an <img src="https://twemoji.maxcdn.com/v/latest/svg/2708.svg" alt="airplane" title="airplane" class="twemoji twemoji-airplane" style="width: 1em; height: 1em; vertical-align: middle;" />️. Going to 🇦🇺. Might see some 🦘! ❤️ Remember to 📱 😀';
